...
HD_PWD='D:/UCH_Vivado_Work/Final_project_team2_test/Final_project_team2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_final_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_final_module.tcl -notrace

...
HD_PWD='D:/UCH_Vivado_Work/Final_project_team2_test/Final_project_team2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_final_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_final_module.tcl

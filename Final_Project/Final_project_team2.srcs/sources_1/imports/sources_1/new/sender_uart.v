...
//     // 상태 정의
//     localparam IDLE = 0, LOAD_TO_DHT11 = 1, WAIT_TO_DHT11 = 2, LOAD_TO_SR04 = 3, WAIT_TO_SR04 = 4;
...
//                 if (btn_sender_up) begin
//                     send_cnt_next = 0;
//                     next_state = LOAD_TO_DHT11;
//                 end
//                 if (btn_sender_down) begin
//                     send_cnt_next = 0;
//                     next_state = LOAD_TO_SR04;
//                 end
//             end
...
//                     endcase
//                     send_next  = 1;
//                     next_state = WAIT_TO_DHT11;
//                 end
//             end

//             WAIT_TO_DHT11: begin
//                 // tx_busy가 다시 올라갔다가 내려오면 다음 문자 전송
//                 if (tx_done) begin
//                     send_cnt_next = send_cnt_reg + 1;
//                     if (send_cnt_reg == 22) next_state = IDLE;
//                     else next_state = LOAD_TO_DHT11;
//                 end
//             end

//             LOAD_TO_SR04: begin  // send
//                 send_next = 0;
//                 if (~w_tx_full && ~w_tx_busy) begin
//                     case (send_cnt_reg)
//                         0:  send_data_next = "D";
...
//                         7:  send_data_next = "e";
//                         8:  send_data_next = ":";
//                         9:  send_data_next = w_send_dist_data[31:24];
//                         10: send_data_next = w_send_dist_data[23:16];
//                         11: send_data_next = w_send_dist_data[15:8];
//                         12: send_data_next = w_send_dist_data[7:0];
//                         13: send_data_next = "c";
//                         14: send_data_next = "m";
//                         15: send_data_next = "\n";
//                     endcase
//                     send_next = 1;
//                     next_state   = WAIT_TO_SR04;
//                 end
//             end
...
//                 if (tx_done) begin
//                     send_cnt_next = send_cnt_reg + 1;
//                     if (send_cnt_reg == 15) next_state = IDLE;
//                     else next_state = LOAD_TO_SR04;
//                 end
//             end
//         endcase
//     end

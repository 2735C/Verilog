...
HD_PWD='C:/Working/FPGA_AI_25_2/2025_adder/2025_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FA_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FA_4.tcl

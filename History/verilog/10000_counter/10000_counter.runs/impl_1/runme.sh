...
HD_PWD='C:/Working/FPGA_AI_25_2/10000_counter/10000_counter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_10000_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TOP_10000_counter.tcl -notrace

...
HD_PWD='C:/Working/FPGA_AI_25_2/250519_stopwatch_btn_debounce/250519_stopwatch_btn_debounce.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_re.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stopwatch_re.tcl -notrace

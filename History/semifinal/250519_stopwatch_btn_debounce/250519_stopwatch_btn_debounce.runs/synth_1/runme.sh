...
HD_PWD='C:/Working/FPGA_AI_25_2/250519_stopwatch_btn_debounce/250519_stopwatch_btn_debounce.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_re.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatch_re.tcl
